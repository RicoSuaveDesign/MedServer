...
(user_id int unsigned not null auto_increment, name varchar(100) not null, pw varchar(200) not null, salt varchar(200) not null, fprint int, allergies tinyint not null, token text, PRIMARY KEY (user_id));
